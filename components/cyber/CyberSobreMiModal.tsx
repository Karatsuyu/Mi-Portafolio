...
const CODE_LINES = [
  ...
  { n: 15, tokens: [{ t: "    'Tecnólogo apasionado por la tecnología,', // ← impacto digital", c: C.yellow }] },
  { n: 16, tokens: [{ t: "    'innovación y soluciones escalables.',", c: C.yellow }] },
  { n: 17, tokens: [{ t: "    'Enfoque en UX/UI + arquitecturas eficientes.',", c: C.yellow }] },
  { n: 18, tokens: [{ t: "    'Autodidacta · Proactivo · Adaptable.',", c: C.yellow }] },
  { n: 19, tokens: [{ t: "  ],", c: C.text }] },
  { n: 20, tokens: [] },
  { n: 21, tokens: [{ t: "  stack: ", c: C.text }, { t: "Stack", c: C.cyan }, { t: " = [", c: C.text }] },
  { n: 22, tokens: [{ t: "    'React', 'Next.js', 'TypeScript',", c: C.green }] },
  { n: 23, tokens: [{ t: "    'Django', 'FastAPI', 'Node.js',", c: C.green }] },
  { n: 24, tokens: [{ t: "    'PostgreSQL', 'Docker', 'AWS',", c: C.green }] },
  { n: 25, tokens: [{ t: "    'Three.js', 'Tailwind', 'Figma',", c: C.green }] },
  { n: 26, tokens: [{ t: "  ],", c: C.text }] },
  { n: 27, tokens: [] },
  { n: 28, tokens: [{ t: "  contact: {", c: C.text }] },
  { n: 29, tokens: [{ t: "    email: ", c: C.text }, { t: '"julian.estiven.gutierrez@correounivalle.edu.co"', c: C.cyan }] },
  { n: 30, tokens: [{ t: "    github: ", c: C.text }, { t: '"github.com/Karatsuyu"', c: C.cyan }] },
  { n: 31, tokens: [{ t: "    linkedin: ", c: C.text }, { t: '"linkedin.com/in/julian-estiven-gutierrez..."', c: C.cyan }] },
  { n: 32, tokens: [{ t: "  },", c: C.text }] },
  { n: 33, tokens: [] },
  { n: 34, tokens: [{ t: "  scc: ", c: C.text }, { t: "SCC[]", c: C.purple }, { t: " = loadCompetencias(),", c: C.text }] },
  { n: 35, tokens: [{ t: "};", c: C.text }] },
  { n: 36, tokens: [] },
  { n: 37, tokens: [{ t: "export default ", c: C.purple }, { t: "developer;", c: C.cyan }] },
];
